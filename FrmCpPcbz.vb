Public Class FrmCpPcbz

    Private Sub FrmCpPcbz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.DgtbcZdcb.Format = g_FormatSl0
        Me.DgtbcZgcb.Format = g_FormatSl0
    ...
    Private Sub PreparePrintData()
        ...
        Try
            rcOleDbCommand.CommandText = "SELECT * FROM rc_rps where rpsid = 'CPPCB'"
        ...
        '套打
        'rcRps.PaperType = 1
        rcRps.Text(-1, 1) = "物料盘存表" & "（" & Trim(Label3.Text) & "）"
