Public Class FrmCsLbYfzkHzz

    Private Sub FrmCsLbYfzkHzz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub PreparePrintData()
        ...
        For i = 0 To rcDataView.Count - 1
            If rcDataView.Item(i).Row.RowState <> 8 Then
                If Not rcDataView.Item(i).Row.Item("csdm").GetType.ToString = "System.DBNull" Then
                    rcRps.Text(j + 1, 1) = Trim(rcDataView.Item(i).Row.Item("csdm"))
                End If
                If Not rcDataView.Item(i).Row.Item("csmc").GetType.ToString = "System.DBNull" Then
                    rcRps.Text(j + 1, 2) = Trim(rcDataView.Item(i).Row.Item("csmc"))
                End If
                ...
                End If
                If Not rcDataView.Item(i).Row.Item("yfje").GetType.ToString = "System.DBNull" Then
                    rcRps.Text(j + 1, 4) = Format(rcDataView.Item(i).Row.Item("yfje"), g_FormatJe0)
                End If
                If Not rcDataView.Item(i).Row.Item("fkje").GetType.ToString = "System.DBNull" Then
                    rcRps.Text(j + 1, 5) = Format(rcDataView.Item(i).Row.Item("fkje"), g_FormatJe0)
                End If
        ...
        Try
            ...
            rcOleDbCommand.CommandText = "SELECT * FROM rc_rps WHERE rpsid = 'YFZKHZ'"
