...
#End Region
    ...
    Private Sub FrmZzyeb_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '默认值
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        ...
        Try
            ...
            '    rcOleDbCommand.CommandText = rcOleDbCommand.CommandText & IIf(i = 1, "", " + ") & "dfje" & i.ToString.PadLeft(2, "0")
            'Next
            'rcOleDbCommand.CommandText = rcOleDbCommand.CommandText & " As ljdf  From gl_kmyeb) zzyeba ,gl_kmxx Where zzyeba.kmdm = gl_kmxx.kmdm"
            'rcOleDbCommand.Parameters.Clear()
            'rcOleDbDataAdpt.SelectCommand = rcOleDbCommand
            'If Not rcDataSet.Tables("zzyeb") Is Nothing Then
            '    rcDataSet.Tables("zzyeb").Clear()
            'End If
            'rcOleDbDataAdpt.Fill(rcDataSet, "zzyeb")
        ...
        Finally
            rcOleDbConn.Close()
        End Try
        Dim rcFrm As New FrmGlKmyebz
        With rcFrm
            .ParaDataView = New DataView(rcDataSet.Tables("zzyeb"), "TRUE", "kmdm", DataViewRowState.CurrentRows)
