    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        ...
        For i = 0 To rcDataSet.Tables("rc_dbdnr").Rows.Count - 1
            ...
            Else
                ...
                End Try
                If rcDataSet.Tables("po_rkd").Rows.Count > 0 Then
                    rcDataSet.Tables("rc_dbdnr").Rows(i).Item("dj") = rcDataSet.Tables("po_rkd").Rows(0).Item("ckje") / rcDataSet.Tables("po_rkd").Rows(0).Item("cksl")
                    rcDataSet.Tables("rc_dbdnr").Rows(i).Item("je") = rcDataSet.Tables("rc_dbdnr").Rows(i).Item("dj") * rcDataSet.Tables("rc_dbdnr").Rows(i).Item("sl")
                End If
            End If
        Next
    End Sub
