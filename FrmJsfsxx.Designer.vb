...
Partial Class FrmJsfsxx
    ...
    Private Sub InitializeComponent()
        ...
        'ColJsfsdm
        '
        Me.ColJsfsdm.DataPropertyName = "jsfsdm"
        Me.ColJsfsdm.HeaderText = "结算方式编码"
        Me.ColJsfsdm.Name = "ColJsfsdm"
        Me.ColJsfsdm.ReadOnly = True
        Me.ColJsfsdm.Width = 120
        '
        'ColJsfsmc
        '
        Me.ColJsfsmc.DataPropertyName = "jsfsmc"
        Me.ColJsfsmc.HeaderText = "结算方式名称"
        Me.ColJsfsmc.Name = "ColJsfsmc"
        Me.ColJsfsmc.ReadOnly = True
        Me.ColJsfsmc.Width = 200
        '
        'ColJsfssm
        '
        Me.ColJsfssm.DataPropertyName = "jsfssm"
        Me.ColJsfssm.HeaderText = "记忆码"
        Me.ColJsfssm.Name = "ColJsfssm"
        Me.ColJsfssm.ReadOnly = True
        Me.ColJsfssm.Width = 120
        '
        'ColBkywf
        '
