...
Public Class FrmOeFpImpDd
    ...
    Private Sub FrmOeFpImpDd_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '取单据类型数据
        Try
            rcOleDbConn.Open()
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        ...
        For j = 0 To rcDataSet.Tables("t_ddnr").Rows.Count - 1
            ...
            If Not blnExists Then
                ...
                rcDataRow.Item("fpmemo") = rcDataSet.Tables("t_ddnr").Rows(j).Item("fpmemo")
                ...
                rcDataRow.Item("xsddjh") = rcDataSet.Tables("t_ddnr").Rows(j).Item("xsddjh")
                rcDataRow.Item("xsdxh") = rcDataSet.Tables("t_ddnr").Rows(j).Item("xsdxh")
