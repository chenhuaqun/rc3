...
#Region "窗体初始化"
    ...
    Private Sub FrmPmCkdSrz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dtCkd.Columns.Add("hth", Type.GetType("System.String"))
        dtCkd.Columns.Add("scph", Type.GetType("System.String"))
...
#Region "控键回车键的处理"
    ...
    Private Sub Control_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CmbPzlxjc.KeyPress, TxtDjh.KeyPress, DtpCkrq.KeyPress, TxtCkdm.KeyPress, TxtBmdm.KeyPress, TxtGxdm.KeyPress, TxtZydm.KeyPress
        ...
        Try
            ...
            If rcDataset.Tables("rc_pzno").Rows.Count > 0 Then
                If rcDataset.Tables("rc_pzno").Rows(0).Item("pzno") >= Mid(Trim(Me.TxtDjh.Text), 11, 5) Then
                    '修改单据
                    rcOleDbCommand.CommandText = "SELECT inv_ckd.djh,inv_ckd.ckrq,inv_ckd.ckdm,inv_ckd.ckmc,inv_ckd.bmdm,inv_ckd.bmmc,inv_ckd.gxdm,inv_ckd.gxmc,inv_ckd.zydm,inv_ckd.zymc,inv_ckd.srr,inv_ckd.shr,inv_ckd.jzr FROM inv_ckd WHERE (inv_ckd.djh = ? )"
                    rcOleDbCommand.Parameters.Clear()
                    ...
                    If rcDataset.Tables("rc_ckdml").Rows.Count > 0 Then
                        If rcDataset.Tables("rc_ckdml").Rows(0).Item("jzr").GetType.ToString <> "System.DBNull" Then
                        ...
                        Else
                            ...
                            Else
                                ...
                                If rcDataset.Tables("rc_ckdml").Rows(0).Item("gxmc").GetType.ToString <> "System.DBNull" Then
                                    Me.LblGxmc.Text = rcDataset.Tables("rc_ckdml").Rows(0).Item("gxmc")
                                End If
...
#Region "导入入库单"
    ...
    Private Sub BtnImp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnImp.Click
        Dim rcFrm As New FrmPmCkdImpRkd
        With rcFrm
    ...
    Private Sub ShowNewDjh()
        If Not IsEditing Then
            ...
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "SELECT pzno" & strMonth & " As pzno FROM rc_lx WHERE kjnd = ? AND pzlxdm = ? and lxgs = '工序出库单'"
                rcOleDbCommand.Parameters.Clear()
                rcOleDbCommand.Parameters.Add("@kjnd", OleDbType.VarChar, 4).Value = strYear
...
#Region "保存单据数据事件"
    ...
    Private Sub SaveEvent(ByVal blnPrint As Boolean)
        ...
        For i = 0 To rcDataSet.Tables("rc_ckdnr").Rows.Count - 1
            ...
            End If
            If rcDataSet.Tables("rc_ckdnr").Rows(i).Item("hth").GetType.ToString = "System.DBNull" Then
                rcDataSet.Tables("rc_ckdnr").Rows(i).Item("hth") = ""
            End If
            If rcDataSet.Tables("rc_ckdnr").Rows(i).Item("scph").GetType.ToString = "System.DBNull" Then
                rcDataSet.Tables("rc_ckdnr").Rows(i).Item("scph") = ""
            End If
        ...
        Try
            ...
            rcOleDbCommand.CommandTimeout = 300
            rcOleDbCommand.CommandType = CommandType.StoredProcedure
            rcOleDbCommand.CommandText = "USP3_SAVE_PM_CKD"
            For i = 0 To rcDataSet.Tables("rc_ckdnr").Rows.Count - 1
                rcOleDbCommand.Parameters.Clear()
                ...
                rcOleDbCommand.Parameters.Add("@paraStrHth", OleDbType.VarChar, 20).Value = rcDataSet.Tables("rc_ckdnr").Rows(i).Item("hth")
                rcOleDbCommand.Parameters.Add("@paraStrScph", OleDbType.VarChar, 20).Value = rcDataSet.Tables("rc_ckdnr").Rows(i).Item("scph")
...
#Region "退出表单事件"
    ...
    Private Sub FrmPmCkdSrz_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        If IsEditing Then
