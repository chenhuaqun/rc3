...
#Region "确定事件"
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        ...
        Try
            ...
            rcOleDbCommand.CommandTimeout = 300
            rcOleDbCommand.CommandType = CommandType.Text
            rcOleDbCommand.CommandText = "SELECT pm_gxlz.dddjh,pm_gxlz.ddxh,pm_gxlz.hth,pm_gxlz.cpdm,pm_gxlz.cpmc,pm_gxlz.dw,pm_gxlz.sl,pm_gxlz.xh,pm_gxlz.gxdm,pm_gxlz.gxmc,pm_gxlz.scjhrq,pm_gxlz.sczydm,pm_gxlz.sczymc,pm_gxlz.dddjh,pm_gxlz.ddxh FROM pm_gxlz WHERE pm_gxlz.scjhrq IS NULL AND bmdm = ? ORDER BY pm_gxlz.dddjh,pm_gxlz.ddxh" ' AND (" & strExpBmdm & ")" & "
            rcOleDbCommand.Parameters.Clear()
