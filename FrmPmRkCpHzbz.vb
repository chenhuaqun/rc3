Public Class FrmPmRkCpHzbz

    Private Sub FrmPmRkCpHzbz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub PreparePrintData()
        ...
        End If
        'Dim rft1 As String = Application.StartupPath + "\reports\pmrkcphzb.csv"
        Dim rft As String = Application.StartupPath + "\reports\pmrkcphzb.rft"
        ...
        Try
            rcOleDbCommand.CommandText = "SELECT * FROM rc_rps where rpsid = 'PMRKCPHZB'"
