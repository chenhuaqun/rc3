...
#Region "显示入库单"
    ...
    Private Sub ShowRkd(ByVal rkDjh As String)
        ...
        Try
            ...
            rcOleDbCommand.CommandTimeout = 300
            rcOleDbCommand.CommandType = CommandType.Text
            'rcOleDbCommand.CommandText = "SELECT po_rkd.cpdm,po_rkd.cpmc,po_rkd.kuwei,po_rkd.pihao,po_rkd.sl,po_rkd.dw,po_rkd.mjsl,po_rkd.fzsl,po_rkd.fzdw,po_rkd.dj,po_rkd.hsdj,po_rkd.je,po_rkd.shlv,po_rkd.se,(po_rkd.je + po_rkd.se) AS jese,po_rkd.rkmemo,po_rkd.cgddjh,po_rkd.cgdxh FROM po_rkd WHERE (po_rkd.djh = ?) ORDER BY po_rkd.xh"
...
#Region "审核"
    ...
    Private Sub ShEvent(ByVal rkDjh As String)
        Try
            ...
            rcOleDbCommand.CommandTimeout = 300
            rcOleDbCommand.CommandType = CommandType.Text
            rcOleDbCommand.CommandText = "UPDATE po_rkd SET shr = ?,shrq = SYSDATE WHERE djh = ? AND shr IS NULL"
            rcOleDbCommand.Parameters.Clear()
...
#Region "消审"
    ...
    Private Sub XsEvent(ByVal rkDjh As String)
        Try
            ...
            rcOleDbCommand.CommandTimeout = 300
            rcOleDbCommand.CommandType = CommandType.Text
            rcOleDbCommand.CommandText = "UPDATE po_rkd SET shr = ?,shrq = SYSDATE WHERE NOT EXISTS (SELECT 1 FROM po_rkd a WHERE a.fkje <> 0 AND a.djh = ?) AND djh = ?"
            rcOleDbCommand.Parameters.Clear()
