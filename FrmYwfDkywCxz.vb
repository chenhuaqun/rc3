Public Class FrmYwfDkywCxz
    ReadOnly i As Integer = 0

    Private Sub FrmYwfDkywCxz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.DgtbcSkje.Format = g_FormatJe0
        Me.DgtbcFyje.Format = g_FormatJe0
        Me.DgtbcDkje.Format = g_FormatJe0
