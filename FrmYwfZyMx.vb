...
#Region "生成明细数据"
    Private Sub ReadYwfZyMx(strZydm As String)
        ...
        Try
            ...
            '小计
            rcOleDbCommand.CommandText = "SELECT '小计' AS khdm,xslbdm,gjxslb,bywfjszz,TO_CHAR(ywfbl,'0.000') || '%'  AS ywfbl,SUM(bnqc) AS bnqc,SUM(bnjf) AS bnjf,SUM(bndf) AS bndf,SUM(bndj) AS bndj,SUM(bnhl) AS bnhl,SUM(ywf_bz) AS ywf_bz,SUM(snhl) AS snhl" &
