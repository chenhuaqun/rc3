Public Class FrmYwfZyMxz
    ReadOnly i As Integer = 0

    Private Sub FrmYwfZyzzMxz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
