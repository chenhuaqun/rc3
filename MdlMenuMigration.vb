...
Module MdlMenuMigration
    ...
    Private Function GetInitDataSql() As String
        ...
        sb.AppendLine("INSERT INTO rc_menu (mnuiid,mnuparentid,mnucaption,mnuiname,mnuiown,mnusortorder,mnuformname) VALUES ('10','0','系统设置(&B)','MnuiBase','RC3',10,NULL);")
        sb.AppendLine("DELETE FROM rc_menu WHERE mnuiown = 'RC3' AND mnuiid = '20';")
        sb.AppendLine("INSERT INTO rc_menu (mnuiid,mnuparentid,mnucaption,mnuiname,mnuiown,mnusortorder,mnuformname) VALUES ('20','0','销售(&OE)','MnuiOe','RC3',20,NULL);")
        sb.AppendLine("DELETE FROM rc_menu WHERE mnuiown = 'RC3' AND mnuiid = '30';")
        sb.AppendLine("INSERT INTO rc_menu (mnuiid,mnuparentid,mnucaption,mnuiname,mnuiown,mnusortorder,mnuformname) VALUES ('30','0','生产(P&M)','MnuiPm','RC3',30,NULL);")
        sb.AppendLine("DELETE FROM rc_menu WHERE mnuiown = 'RC3' AND mnuiid = '40';")
        sb.AppendLine("INSERT INTO rc_menu (mnuiid,mnuparentid,mnucaption,mnuiname,mnuiown,mnusortorder,mnuformname) VALUES ('40','0','采购(&PO)','MnuiPo','RC3',40,NULL);")
        sb.AppendLine("DELETE FROM rc_menu WHERE mnuiown = 'RC3' AND mnuiid = '50';")
        sb.AppendLine("INSERT INTO rc_menu (mnuiid,mnuparentid,mnucaption,mnuiname,mnuiown,mnusortorder,mnuformname) VALUES ('50','0','库存(&INV)','MnuiInv','RC3',50,NULL);")
        sb.AppendLine("DELETE FROM rc_menu WHERE mnuiown = 'RC3' AND mnuiid = '60';")
        sb.AppendLine("INSERT INTO rc_menu (mnuiid,mnuparentid,mnucaption,mnuiname,mnuiown,mnusortorder,mnuformname) VALUES ('60','0','财务(&F)','MnuiArAp','RC3',60,NULL);")
        sb.AppendLine("DELETE FROM rc_menu WHERE mnuiown = 'RC3' AND mnuiid = '70';")
        sb.AppendLine("INSERT INTO rc_menu (mnuiid,mnuparentid,mnucaption,mnuiname,mnuiown,mnusortorder,mnuformname) VALUES ('70','0','成本(&CM)','MnuiCb','RC3',70,NULL);")
        sb.AppendLine("DELETE FROM rc_menu WHERE mnuiown = 'RC3' AND mnuiid = '80';")
        sb.AppendLine("INSERT INTO rc_menu (mnuiid,mnuparentid,mnucaption,mnuiname,mnuiown,mnusortorder,mnuformname) VALUES ('80','0','总账(&GL)','MnuiGl','RC3',80,NULL);")
        sb.AppendLine("DELETE FROM rc_menu WHERE mnuiown = 'RC3' AND mnuiid = '90';")
        sb.AppendLine("INSERT INTO rc_menu (mnuiid,mnuparentid,mnucaption,mnuiname,mnuiown,mnusortorder,mnuformname) VALUES ('90','0','期末(&T)','MnuiYwf','RC3',90,NULL);")
        sb.AppendLine("DELETE FROM rc_menu WHERE mnuiown = 'RC3' AND mnuiid = '99';")
        sb.AppendLine("INSERT INTO rc_menu (mnuiid,mnuparentid,mnucaption,mnuiname,mnuiown,mnusortorder,mnuformname) VALUES ('99','0','系统服务(&S)','MnuiSys','RC3',99,NULL);")
