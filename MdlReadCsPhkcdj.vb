...
Module MdlReadCsPhKcdj

    Friend Function ReadCsPhKcdj(ByVal strCpdm As String, ByVal strCsdm As String, ByVal strPiHao As String, ByVal strCkdm As String, ByVal blnFuShu As Boolean) As Double
        '建立数据适配器
            ...
            If Not blnFuShu Then
                ...
                If Not String.IsNullOrEmpty(strCsdm) Then
                    If Not String.IsNullOrEmpty(strPiHao) Then
                        ...
                        rcOleDbCommand.Parameters.Add("@pihao", OleDbType.VarChar, 30).Value = strPiHao
