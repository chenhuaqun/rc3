Public Class FrmKhLbYszkHzz

    Private Sub FrmKhLbYszkHzz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub PreparePrintData()
        ...
        End If
        'Dim rft1 As String =Application.StartupPath + "\reports\yszkhz.csv"
        Dim rft As String =Application.StartupPath + "\reports\yszkhz.rft"
