...
#Region "��ʼ��"
    ...
    Private Sub FrmJsfsEdit_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.TxtJsfsdm.DataBindings.Add("Text", rcDataView, "jsfsdm")
...
#Region "���ÿؼ�"
    ...
    Private Sub SetAll(ByVal medit As Boolean)
        If Not medit Then
            Me.TxtJsfsdm.Enabled = False
            Me.TxtJsfssm.Enabled = False
            Me.TxtJsfsmc.Enabled = False
        ...
        Else
            Me.TxtJsfsdm.Enabled = True
            Me.TxtJsfssm.Enabled = True
            Me.TxtJsfsmc.Enabled = True
...
#Region "���㷽ʽ�����¼�"
    ...
    Private Sub TxtJsfsmc_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TxtJsfsmc.Validating
        ...
        Me.TxtJsfssm.Text = Trim(Mid(spell.GetChineseSpell(Me.TxtJsfsmc.Text), 1, 12))
    End Sub
