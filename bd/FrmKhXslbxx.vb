...
#Region "定义变量"
    ...
    ReadOnly dtKhxslb As New DataTable("rc_khxslb")
    '打印文档
...
#Region "初始化"
    ...
    Private Sub FrmKhXslbxx_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load

        '数据绑定
        dtKhxslb.Columns.Add("xslbdm", Type.GetType("System.String"))
        dtKhxslb.Columns.Add("xslbmc", Type.GetType("System.String"))
        dtKhxslb.Columns.Add("xslbsm", Type.GetType("System.String"))
        dtKhxslb.Columns.Add("ywfbl", Type.GetType("System.Double"))
        dtKhxslb.Columns.Add("gjxslb", Type.GetType("System.Boolean"))
        rcDataset.Tables.Add(dtKhxslb)
        With dtKhxslb
            .Columns("xslbdm").DefaultValue = ""
            .Columns("xslbmc").DefaultValue = ""
            .Columns("xslbsm").DefaultValue = ""
            .Columns("ywfbl").DefaultValue = 0
        ...
        Finally
            rcOleDbConn.Close()
        End Try
        rcDataView = New DataView(rcDataset.Tables("rc_khxslb"))
...
#Region "打印、打印预览"
    ...
    Private Sub PreparePrintData()
        'Dim rft1 As String =Application.StartupPath + "\reports\khxslbxx.csv"
        Dim rft As String =Application.StartupPath + "\reports\khxslbxx.rft"
        ...
        Dim i As Integer
        For i = 0 To rcDataset.Tables("rc_khxslb").Rows.Count - 1
            rcRps.Text(i + 1, 1) = Trim(rcDataset.Tables("rc_khxslb").Rows(i).Item("xslbdm"))
            rcRps.Text(i + 1, 2) = Trim(rcDataset.Tables("rc_khxslb").Rows(i).Item("xslbmc"))
            rcRps.Text(i + 1, 3) = Trim(rcDataset.Tables("rc_khxslb").Rows(i).Item("xslbsm"))
        Next
        '取RPS数据
        Try
            rcOleDbConn.Open()
            ...
            rcOleDbCommand.CommandTimeout = 300
            rcOleDbCommand.CommandType = CommandType.Text
            rcOleDbCommand.CommandText = "SELECT * FROM rc_rps WHERE rpsid = 'KHXSLB'"
            rcOleDbCommand.Parameters.Clear()
            rcOleDbDataAdpt.SelectCommand = rcOleDbCommand
...
#Region "输出"
    ...
    Private Sub BtnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnExport.Click, MnuiExport.Click
        '导出数据
        Exports2Excel(rcDataset.Tables("rc_khxslb"))
    End Sub
...
#Region "新增"
    ...
    Private Sub BtnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnNew.Click, MnuiNew.Click
        '新增
        Dim rcFrm As New FrmKhXslbEdit
        With rcFrm
            .ParaAdding = True
...
#Region "删除"
    ...
    Private Sub BtnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnDelete.Click, MnuiDelete.Click
        '删除
        '删除数据
        If MessageBox.Show("您真地要删除吗？" & Trim(BindingContext(rcDataView, "").Current("xslbdm")), "提示信息", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.OK Then
            currentPos = BindingContext(rcDataView, "").Position
            If Trim(BindingContext(rcDataView, "").Current("xslbdm")) = "" Then
            ...
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "DELETE FROM rc_khxslb WHERE xslbdm = ?"
                rcOleDbCommand.Parameters.Clear()
                rcOleDbCommand.Parameters.AddWithValue("@xslbdm", BindingContext(rcDataView, "").Current("xslbdm"))
