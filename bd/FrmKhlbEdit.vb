...
#Region "初始化"
    ...
    Private Sub FrmKhlbEdit_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub SaveEvent()
        ...
        If isAdding Then
            ...
            Try
                ...
                rcOleDbCommand.CommandText = "Insert Into rc_khlb (lbdm,lbmc,lbsm) VALUES (?,?,?)"
        ...
        Else
            ...
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "UPDATE rc_khlb SET lbmc = ? , lbsm = ? WHERE  lbdm = ?"
                rcOleDbCommand.Parameters.Clear()
