...
#Region "初始化"
    ...
    Private Sub FrmZcclslSrz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '是否按成本域计算成本
...
#Region "控键回车键的处理"
    ...
    Private Sub Control_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtBmdm.KeyPress, TxtCpdm.KeyPress, TxtCpmc.KeyPress, TxtGxdm.KeyPress, TxtGxmc.KeyPress, TxtZcclsl.KeyPress
    ...
    Private Sub LoadSavedZcclsl()
        ...
        If Not String.IsNullOrEmpty(Me.TxtBmdm.Text) And Not String.IsNullOrEmpty(Me.TxtCpdm.Text) And Not String.IsNullOrEmpty(Me.TxtGxdm.Text) Then
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "SELECT zcclsl FROM pm_zccl WHERE cperiod = ? AND bmdm = ? AND cpdm = ? AND gxdm = ?"
                rcOleDbCommand.Parameters.Clear()
                ...
                If rcDataSet.Tables("pm_zccl") IsNot Nothing Then
                    rcDataSet.Tables("pm_zccl").Clear()
                End If
            ...
            If rcDataSet.Tables("pm_zccl").Rows.Count > 0 Then
                Me.TxtZcclsl.Text = rcDataSet.Tables("pm_zccl").Rows(0).Item("zcclsl")
            Else
                Me.TxtZcclsl.Text = 0.0
            End If
        End If
...
#Region "保存数据事件"
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        ...
        Try
            ...
            rcOleDbCommand.CommandTimeout = 300
            rcOleDbCommand.CommandType = CommandType.Text
            rcOleDbCommand.CommandText = "SELECT * FROM pm_zccl WHERE cperiod = ? AND bmdm = ? AND cpdm = ? AND gxdm = ?"
            rcOleDbCommand.Parameters.Clear()
            rcOleDbCommand.Parameters.Add("@cperiod", OleDbType.VarChar, 6).Value = strKjqj
            rcOleDbCommand.Parameters.Add("@bmdm", OleDbType.VarChar, 12).Value = Trim(Me.TxtBmdm.Text).ToUpper
            rcOleDbCommand.Parameters.Add("@cpdm", OleDbType.VarChar, 15).Value = Trim(Me.TxtCpdm.Text).ToUpper
        ...
        If rcDataSet.Tables("pm_zccl").Rows.Count <= 0 Then
            ...
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "INSERT INTO pm_zccl (cperiod,bmdm,cpdm,gxdm,zcclsl,cldj,zcclje) values (?,?,?,?,?,0.0,0.0)"
                rcOleDbCommand.Parameters.Clear()
                rcOleDbCommand.Parameters.Add("@cperiod", OleDbType.VarChar, 6).Value = strKjqj
                rcOleDbCommand.Parameters.Add("@bmdm", OleDbType.VarChar, 12).Value = Trim(Me.TxtBmdm.Text).ToUpper
                rcOleDbCommand.Parameters.Add("@cpdm", OleDbType.VarChar, 15).Value = Trim(Me.TxtCpdm.Text).ToUpper
                rcOleDbCommand.Parameters.Add("@gxdm", OleDbType.VarChar, 12).Value = Trim(Me.TxtGxdm.Text).ToUpper
                rcOleDbCommand.Parameters.Add("@zcclsl", OleDbType.Numeric, 18).Value = Me.TxtZcclsl.Text
        ...
        Else
            ...
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "UPDATE pm_zccl set zcclsl = ? WHERE cperiod = ? AND bmdm = ? AND cpdm = ? AND gxdm = ?"
                rcOleDbCommand.Parameters.Clear()
                rcOleDbCommand.Parameters.Add("@zcclsl", OleDbType.Numeric, 18).Value = Me.TxtZcclsl.Text
                rcOleDbCommand.Parameters.Add("@cperiod", OleDbType.VarChar, 6).Value = strKjqj
                rcOleDbCommand.Parameters.Add("@bmdm", OleDbType.VarChar, 12).Value = Trim(Me.TxtBmdm.Text).ToUpper
...
#Region "读入excel"
    ...
    Private Sub BtnImpXls_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnImpXls.Click, MnuiImpXls.Click
        '调用表单
        Dim rcFrm As New FrmZcclslImpXls
        With rcFrm
            .ParaStrKjqj = strKjqj
