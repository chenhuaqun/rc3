...
#Region "初始化"
    ...
    Private Sub FrmKmMxz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '默认值
...
#Region "确定事件"
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        ...
        For i = Me.NudMonthBegin.Value To Me.NudMonthEnd.Value
            datePzrqBegin = getInvBegin(Me.NudYear.Value, i)
            ...
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "SELECT '" & datePzrqEnd.ToString & "' As pzrq,'本月合计' As zy,COALESCE(SUM(CASE WHEN jd = '借' THEN gl_pz.je ELSE 0.0 END),0.0) As jfje,COALESCE(SUM(CASE WHEN jd = '贷' THEN gl_pz.je ELSE 0.0 END),0.0) As dfje FROM gl_pz WHERE gl_pz.bdelete = 0 AND kmdm = ? AND gl_pz.pzrq >= ? AND gl_pz.pzrq >= ? AND gl_pz.pzrq <= ?"
                rcOleDbCommand.Parameters.Clear()
