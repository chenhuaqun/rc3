Public Class FrmFcspKhSfcHzz

    Private Sub FrmFcspJeSfcHzz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.DgtbcJcfcspje.Format = g_FormatJe0
