Public Class FrmFcspPcbz

    Private Sub FrmFcspPcbz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.DgtbcCgdj.Format = g_FormatJe0
    ...
    Private Sub PreparePrintData()
        ...
        End If
        'Dim rft1 As String = Application.StartupPath + "\reports\fcsppcb.csv"
        Dim rft As String = Application.StartupPath + "\reports\fcsppcb.rft"
        ...
        Try
            rcOleDbCommand.CommandText = "SELECT * FROM rc_rps where rpsid = 'FCSPPCB'"
        ...
        '套打
        'rcRps.PaperType = 1
        rcRps.Text(-1, 1) = "发出商品盘存表" & "（" & Trim(Label3.Text) & "）"
