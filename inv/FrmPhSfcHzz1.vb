Public Class FrmPhSfcHzz1

    Private Sub FrmPhSfcHzz1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.DgtbcCkfzsl.Format = g_FormatJe0
    ...
    Private Sub PreparePrintData()
        ...
        Try
            rcOleDbCommand.CommandText = "SELECT * FROM rc_rps where rpsid = 'SFCHZ'"
