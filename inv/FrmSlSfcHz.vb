        ...
        If Me.rdoCk.Checked Then
            ...
            Try
                ...
                rcOleDbCommand.CommandText = "SELECT bsfchz.cpdm,bsfchz.cpmc,bsfchz.dw,bsfchz.ckdm,bsfchz.ckmc" & _
                    ...
                    " (SELECT COALESCE(cpnc.cpdm,qcscrk.cpdm,qccgrk.cpdm,qcdbrk.cpdm,qcxsck.cpdm,qcckck.cpdm,qcdbck.cpdm,bqscrk.cpdm,bqcgrk.cpdm,bqdbrk.cpdm,bqxsck.cpdm,bqckck.cpdm,bqdbck.cpdm) AS cpdm,COALESCE(cpnc.ckdm,qcscrk.ckdm,qccgrk.ckdm,qcdbrk.ckdm,qcxsck.ckdm,qcckck.ckdm,qcdbck.ckdm,bqscrk.ckdm,bqcgrk.ckdm,bqdbrk.ckdm,bqxsck.ckdm,bqckck.ckdm,bqdbck.ckdm) AS ckdm,cpnc.qcsl,cpnc.qcfzsl,qcscrk.qcscrksl,qcscrk.qcscrkfzsl,qccgrk.qccgrksl,qccgrk.qccgrkfzsl,qcdbrk.qcdbrksl,qcdbrk.qcdbrkfzsl,qcxsck.qcxscksl,qcxsck.qcxsckfzsl,qcckck.qcckcksl,qcckck.qcckckfzsl,qcdbck.qcdbcksl,qcdbck.qcdbckfzsl,bqscrk.bqscrksl,bqscrk.bqscrkfzsl,bqcgrk.bqcgrksl,bqcgrk.bqcgrkfzsl,bqdbrk.bqdbrksl,bqdbrk.bqdbrkfzsl,bqxsck.bqxscksl,bqxsck.bqxsckfzsl,bqckck.bqckcksl,bqckck.bqckckfzsl,bqdbck.bqdbcksl,bqdbck.bqdbckfzsl FROM" & _
                    ...
                    " UNION ALL (SELECT po_rkd.cpdm,po_rkd.ckdm,sum(po_rkd.sl) as qccgrksl,sum(po_rkd.fzsl) as qccgrkfzsl FROM po_rkd WHERE po_rkd.bdelete = 0 AND TRUNC(po_rkd.rkrq,'mi') >= ? and TRUNC(po_rkd.rkrq,'mi') >= ? and TRUNC(po_rkd.rkrq,'mi') < ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND po_rkd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND po_rkd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY po_rkd.cpdm,po_rkd.ckdm) qccgrk ON cpnc.cpdm = qccgrk.cpdm AND cpnc.ckdm = qccgrk.ckdm" & _
                    ...
                    " UNION ALL (SELECT oe_xsd.cpdm,oe_xsd.ckdm,sum(oe_xsd.sl) as qcxscksl,sum(oe_xsd.fzsl) as qcxsckfzsl FROM oe_xsd WHERE oe_xsd.bdelete = 0 AND TRUNC(oe_xsd.xsrq,'mi') >= ? and TRUNC(oe_xsd.xsrq,'mi') >= ? and TRUNC(oe_xsd.xsrq,'mi') < ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND oe_xsd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND oe_xsd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY oe_xsd.cpdm,oe_xsd.ckdm) qcxsck ON cpnc.cpdm = qcxsck.cpdm AND cpnc.ckdm = qcxsck.ckdm" & _
                    " UNION ALL (SELECT inv_ckd.cpdm,inv_ckd.ckdm,sum(inv_ckd.sl) as qcckcksl,sum(inv_ckd.fzsl) as qcckckfzsl FROM inv_ckd WHERE inv_ckd.bdelete = 0 AND TRUNC(inv_ckd.ckrq,'mi') >= ? and TRUNC(inv_ckd.ckrq,'mi') >= ? and TRUNC(inv_ckd.ckrq,'mi') < ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND inv_ckd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND inv_ckd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY inv_ckd.cpdm,inv_ckd.ckdm) qcckck ON cpnc.cpdm = qcckck.cpdm AND cpnc.ckdm = qcckck.ckdm" & _
                    " UNION ALL (SELECT inv_dbd.cpdm,inv_dbd.cckdm AS ckdm,sum(inv_dbd.sl) as qcdbcksl,sum(inv_dbd.fzsl) as qcdbckfzsl FROM inv_dbd WHERE inv_dbd.bdelete = 0 AND TRUNC(inv_dbd.dbrq,'mi') >= ? and TRUNC(inv_dbd.dbrq,'mi') >= ? and TRUNC(inv_dbd.dbrq,'mi') < ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND inv_dbd.cckdm >='" & Me.TxtCkdmBegin.Text & "' AND inv_dbd.cckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY inv_dbd.cpdm,inv_dbd.cckdm) qcdbck ON cpnc.cpdm = qcdbck.cpdm AND cpnc.ckdm = qcdbck.ckdm" & _
                    ...
                    " UNION ALL (SELECT po_rkd.cpdm,po_rkd.ckdm,sum(po_rkd.sl) as bqcgrksl,sum(po_rkd.fzsl) as bqcgrkfzsl FROM po_rkd WHERE po_rkd.bdelete = 0 AND TRUNC(po_rkd.rkrq,'mi') >= ? and TRUNC(po_rkd.rkrq,'mi') >= ? and TRUNC(po_rkd.rkrq,'mi') <= ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND po_rkd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND po_rkd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY po_rkd.cpdm,po_rkd.ckdm) bqcgrk ON cpnc.cpdm = bqcgrk.cpdm AND cpnc.ckdm = bqcgrk.ckdm" & _
        ...
        Else
            ...
            Try
                ...
                rcOleDbCommand.CommandText = "SELECT bsfchz.cpdm,bsfchz.cpmc,bsfchz.dw" & _
                    ...
                    " (SELECT COALESCE(cpnc.cpdm,qcscrk.cpdm,qccgrk.cpdm,qcdbrk.cpdm,qcxsck.cpdm,qcckck.cpdm,qcdbck.cpdm,bqscrk.cpdm,bqcgrk.cpdm,bqdbrk.cpdm,bqxsck.cpdm,bqckck.cpdm,bqdbck.cpdm) AS cpdm,cpnc.qcsl,cpnc.qcfzsl,qcscrk.qcscrksl,qcscrk.qcscrkfzsl,qccgrk.qccgrksl,qccgrk.qccgrkfzsl,qcdbrk.qcdbrksl,qcdbrk.qcdbrkfzsl,qcxsck.qcxscksl,qcxsck.qcxsckfzsl,qcckck.qcckcksl,qcckck.qcckckfzsl,qcdbck.qcdbcksl,qcdbck.qcdbckfzsl,bqscrk.bqscrksl,bqscrk.bqscrkfzsl,bqcgrk.bqcgrksl,bqcgrk.bqcgrkfzsl,bqdbrk.bqdbrksl,bqdbrk.bqdbrkfzsl,bqxsck.bqxscksl,bqxsck.bqxsckfzsl,bqckck.bqckcksl,bqckck.bqckckfzsl,bqdbck.bqdbcksl,bqdbck.bqdbckfzsl FROM" & _
                    ...
                    " UNION ALL (SELECT inv_rkd.cpdm,sum(inv_rkd.sl) as qcscrksl,sum(inv_rkd.fzsl) as qcscrkfzsl FROM inv_rkd WHERE inv_rkd.bdelete = 0 AND TRUNC(inv_rkd.rkrq,'mi') >= ? and TRUNC(inv_rkd.rkrq,'mi') >= ? and TRUNC(inv_rkd.rkrq,'mi') < ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND inv_rkd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND inv_rkd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY inv_rkd.cpdm) qcscrk ON cpnc.cpdm = qcscrk.cpdm" & _
                    " UNION ALL (SELECT po_rkd.cpdm,sum(po_rkd.sl) as qccgrksl,sum(po_rkd.fzsl) as qccgrkfzsl FROM po_rkd WHERE po_rkd.bdelete = 0 AND TRUNC(po_rkd.rkrq,'mi') >= ? and TRUNC(po_rkd.rkrq,'mi') >= ? and TRUNC(po_rkd.rkrq,'mi') < ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND po_rkd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND po_rkd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY po_rkd.cpdm) qccgrk ON cpnc.cpdm = qccgrk.cpdm" & _
                    " UNION ALL (SELECT inv_dbd.cpdm,sum(inv_dbd.sl) as qcdbrksl,sum(inv_dbd.fzsl) as qcdbrkfzsl FROM inv_dbd WHERE inv_dbd.bdelete = 0 AND TRUNC(inv_dbd.dbrq,'mi') >= ? and TRUNC(inv_dbd.dbrq,'mi') >= ? and TRUNC(inv_dbd.dbrq,'mi') < ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND inv_dbd.rckdm >='" & Me.TxtCkdmBegin.Text & "' AND inv_dbd.rckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY inv_dbd.cpdm) qcdbrk ON cpnc.cpdm = qcdbrk.cpdm" & _
                    " UNION ALL (SELECT oe_xsd.cpdm,sum(oe_xsd.sl) as qcxscksl,sum(oe_xsd.fzsl) as qcxsckfzsl FROM oe_xsd WHERE oe_xsd.bdelete = 0 AND TRUNC(oe_xsd.xsrq,'mi') >= ? and TRUNC(oe_xsd.xsrq,'mi') >= ? and TRUNC(oe_xsd.xsrq,'mi') < ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND oe_xsd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND oe_xsd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY oe_xsd.cpdm) qcxsck ON cpnc.cpdm = qcxsck.cpdm" & _
                    " UNION ALL (SELECT inv_ckd.cpdm,sum(inv_ckd.sl) as qcckcksl,sum(inv_ckd.fzsl) as qcckckfzsl FROM inv_ckd WHERE inv_ckd.bdelete = 0 AND TRUNC(inv_ckd.ckrq,'mi') >= ? and TRUNC(inv_ckd.ckrq,'mi') >= ? and TRUNC(inv_ckd.ckrq,'mi') < ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND inv_ckd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND inv_ckd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY inv_ckd.cpdm) qcckck ON cpnc.cpdm = qcckck.cpdm" & _
                    " UNION ALL (SELECT inv_dbd.cpdm,sum(inv_dbd.sl) as qcdbcksl,sum(inv_dbd.fzsl) as qcdbckfzsl FROM inv_dbd WHERE inv_dbd.bdelete = 0 AND TRUNC(inv_dbd.dbrq,'mi') >= ? and TRUNC(inv_dbd.dbrq,'mi') >= ? and TRUNC(inv_dbd.dbrq,'mi') < ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND inv_dbd.cckdm >='" & Me.TxtCkdmBegin.Text & "' AND inv_dbd.cckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY inv_dbd.cpdm) qcdbck ON cpnc.cpdm = qcdbck.cpdm" & _
                    " UNION ALL (SELECT inv_rkd.cpdm,sum(inv_rkd.sl) as bqscrksl,sum(inv_rkd.fzsl) as bqscrkfzsl FROM inv_rkd WHERE inv_rkd.bdelete = 0 AND TRUNC(inv_rkd.rkrq,'mi') >= ? and TRUNC(inv_rkd.rkrq,'mi') >= ? and TRUNC(inv_rkd.rkrq,'mi') <= ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND inv_rkd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND inv_rkd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY inv_rkd.cpdm) bqscrk ON cpnc.cpdm = bqscrk.cpdm" & _
                    " UNION ALL (SELECT po_rkd.cpdm,sum(po_rkd.sl) as bqcgrksl,sum(po_rkd.fzsl) as bqcgrkfzsl FROM po_rkd WHERE po_rkd.bdelete = 0 AND TRUNC(po_rkd.rkrq,'mi') >= ? and TRUNC(po_rkd.rkrq,'mi') >= ? and TRUNC(po_rkd.rkrq,'mi') <= ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND po_rkd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND po_rkd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY po_rkd.cpdm) bqcgrk ON cpnc.cpdm = bqcgrk.cpdm" & _
                    " UNION ALL (SELECT inv_dbd.cpdm,sum(inv_dbd.sl) as bqdbrksl,sum(inv_dbd.fzsl) as bqdbrkfzsl FROM inv_dbd WHERE inv_dbd.bdelete = 0 AND TRUNC(inv_dbd.dbrq,'mi') >= ? and TRUNC(inv_dbd.dbrq,'mi') >= ? and TRUNC(inv_dbd.dbrq,'mi') <= ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND inv_dbd.rckdm >='" & Me.TxtCkdmBegin.Text & "' AND inv_dbd.rckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY inv_dbd.cpdm) bqdbrk ON cpnc.cpdm = bqdbrk.cpdm" & _
                    " UNION ALL (SELECT oe_xsd.cpdm,sum(oe_xsd.sl) as bqxscksl,sum(oe_xsd.fzsl) as bqxsckfzsl FROM oe_xsd WHERE oe_xsd.bdelete = 0 AND TRUNC(oe_xsd.xsrq,'mi') >= ? and TRUNC(oe_xsd.xsrq,'mi') >= ? and TRUNC(oe_xsd.xsrq,'mi') <= ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND oe_xsd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND oe_xsd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY oe_xsd.cpdm) bqxsck ON cpnc.cpdm = bqxsck.cpdm" & _
                    " UNION ALL (SELECT inv_ckd.cpdm,sum(inv_ckd.sl) as bqckcksl,sum(inv_ckd.fzsl) as bqckckfzsl FROM inv_ckd WHERE inv_ckd.bdelete = 0 AND TRUNC(inv_ckd.ckrq,'mi') >= ? and TRUNC(inv_ckd.ckrq,'mi') >= ? and TRUNC(inv_ckd.ckrq,'mi') <= ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND inv_ckd.ckdm >='" & Me.TxtCkdmBegin.Text & "' AND inv_ckd.ckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY inv_ckd.cpdm) bqckck ON cpnc.cpdm = bqckck.cpdm" & _
                    " UNION ALL (SELECT inv_dbd.cpdm,sum(inv_dbd.sl) as bqdbcksl,sum(inv_dbd.fzsl) as bqdbckfzsl FROM inv_dbd WHERE inv_dbd.bdelete = 0 AND TRUNC(inv_dbd.dbrq,'mi') >= ? and TRUNC(inv_dbd.dbrq,'mi') >= ? and TRUNC(inv_dbd.dbrq,'mi') <= ?" & IIf(Not String.IsNullOrEmpty(Me.TxtCkdmBegin.Text), " AND inv_dbd.cckdm >='" & Me.TxtCkdmBegin.Text & "' AND inv_dbd.cckdm <= '" & Me.TxtCkdmEnd.Text & "'", "") & " GROUP BY inv_dbd.cpdm) bqdbck ON cpnc.cpdm = bqdbck.cpdm) asfchz LEFT JOIN rc_cpxx ON asfchz.cpdm = rc_cpxx.cpdm) bsfchz WHERE (" & strExpLbdm & ")" & IIf(Not String.IsNullOrEmpty(Me.TxtLbdm.Text), " AND lbdm LIKE '" & Me.TxtLbdm.Text & "%'", "") & IIf(Not String.IsNullOrEmpty(Me.TxtCpdmBegin.Text), " and cpdm LIKE '" & Trim(TxtCpdmBegin.Text) & "%'", "") & IIf(Not String.IsNullOrEmpty(Me.TxtCpmc.Text), " AND cpmc LIKE '%" & TxtCpmc.Text & "%'", "")
                rcOleDbCommand.Parameters.Clear()
                rcOleDbCommand.Parameters.Add("@kjnd", OleDbType.VarChar, 4).Value = Mid(strKjqj, 1, 4)
                rcOleDbCommand.Parameters.Add("@rkrq", OleDbType.Date, 8).Value = g_Dwrq.Date
                rcOleDbCommand.Parameters.Add("@rkrq", OleDbType.Date, 8).Value = dInvBegin1.Date
