...
#Region "初始化"
    ...
    Private Sub FrmOeBjdCxz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '设置DataGridView
...
#End Region
    ...
    Private Sub BtnBottom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBottom.Click
        If bmbBjdml.Count > 0 Then
            bmbBjdml.Position = bmbBjdml.Count - 1
            ShowBjd(bmbBjdml.Current("djh"))
        End If
    End Sub
