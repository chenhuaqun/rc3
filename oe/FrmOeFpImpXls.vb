    ...
    Private Sub TsbSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TsbSave.Click
        ...
        If Me.RadioButton1.Checked Then
            Try
                ...
                '删除已保存的数据
                rcOleDbCommand.CommandText = "DELETE FROM oe_fp WHERE SUBSTR(djh,1,10) = ?"
        ...
        For i = 0 To rcDataset.Tables("result").Rows.Count - 1
            Try
                ...
                rcOleDbCommand.Parameters.Add("@paraDateFprq", OleDbType.Date, 8).Value = rcDataset.Tables("result").Rows(i).Item("发票日期")
                ...
                rcOleDbCommand.Parameters.Add("@ParaStrShKhdm", OleDbType.VarChar, 12).Value = rcDataset.Tables("result").Rows(i).Item("客户编码")
                rcOleDbCommand.Parameters.Add("@paraStrShKhmc", OleDbType.VarChar, 30).Value = rcDataset.Tables("result").Rows(i).Item("客户名称")
                rcOleDbCommand.Parameters.Add("@paraStrYspz", OleDbType.VarChar, 30).Value = rcDataset.Tables("result").Rows(i).Item("发票号")
                ...
                rcOleDbCommand.Parameters.Add("@paraStrSgddh", OleDbType.VarChar, 30).Value = rcDataset.Tables("result").Rows(i).Item("手工订单号")
                ...
                rcOleDbCommand.Parameters.Add("@paraDblDj", OleDbType.Numeric, 18).Value = rcDataset.Tables("result").Rows(i).Item("不含税单价")
                ...
                rcOleDbCommand.Parameters.Add("@paraDblShlv", OleDbType.Numeric, 6).Value = rcDataset.Tables("result").Rows(i).Item("税率")
                rcOleDbCommand.Parameters.Add("@paraDblSe", OleDbType.Numeric, 14).Value = rcDataset.Tables("result").Rows(i).Item("税额")
                rcOleDbCommand.Parameters.Add("@paraStrFpmemo", OleDbType.VarChar, 50).Value = rcDataset.Tables("result").Rows(i).Item("备注")
                rcOleDbCommand.Parameters.Add("@paraStrDdDjh", OleDbType.VarChar, 15).Value = rcDataset.Tables("result").Rows(i).Item("销售订单单据号")
                rcOleDbCommand.Parameters.Add("@paraIntDdXh", OleDbType.Integer, 4).Value = rcDataset.Tables("result").Rows(i).Item("销售订单行号")
                rcOleDbCommand.Parameters.Add("@paraStrXsdDjh", OleDbType.VarChar, 15).Value = rcDataset.Tables("result").Rows(i).Item("送货单单据号")
                rcOleDbCommand.Parameters.Add("@paraIntXsdXh", OleDbType.Integer, 4).Value = rcDataset.Tables("result").Rows(i).Item("送货单行号")
            ...
            End Try
        Next
        MsgBox("产品销售发票读入完成,请检查数据。", MsgBoxStyle.OkOnly + MsgBoxStyle.Question, "提示信息")
        Me.Close()
    End Sub
