    ...
    Private Sub TsbSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TsbSave.Click
        ...
        If Me.RadioButton1.Checked Then
            Try
                ...
                '删除已保存的数据
                rcOleDbCommand.CommandText = "DELETE FROM oe_xsd WHERE SUBSTR(djh,1,10) = ?"
        ...
        For i = 0 To rcDataset.Tables("result").Rows.Count - 1
            Try
                ...
                rcOleDbCommand.Parameters.Add("@paraDblLt", OleDbType.Numeric, 18).Value = 0
                ...
                rcOleDbCommand.Parameters.Add("@paraStrXsmemo", OleDbType.VarChar, 50).Value = rcDataset.Tables("result").Rows(i).Item("备注")
                rcOleDbCommand.Parameters.Add("@paraStrDdDjh", OleDbType.VarChar, 15).Value = rcDataset.Tables("result").Rows(i).Item("订单单据号")
            ...
            End Try
        Next
        MsgBox("产品送货单读入完成,请检查数据。", MsgBoxStyle.OkOnly + MsgBoxStyle.Question, "提示信息")
        Me.Close()
    End Sub
