Public Class FrmCkDbCpHzbz

    Private Sub FrmCkDbCpHzbz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub PreparePrintData()
        ...
        End If
        'Dim rft1 As String = Application.StartupPath + "\reports\ckdbcphzb.csv"
        Dim rft As String = Application.StartupPath + "\reports\ckdbcphzb.rft"
        ...
        Try
            rcOleDbCommand.CommandText = "SELECT * FROM rc_rps where rpsid = 'CKDBCPHZB'"
        ...
        '套打
        'rcRps.PaperType = 1
        rcRps.Text(-1, 1) = "仓库调拨物料汇总表" '’ & "（" & Trim(Label3.Text) & "）"
