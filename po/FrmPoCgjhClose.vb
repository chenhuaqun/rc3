...
Public Class FrmPoCgjhClose
    ...
    Private Sub FrmPoCgjhClose_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '设置DataGridView
        ...
        Me.rcDataGridView.Columns("ColCgsl").DefaultCellStyle.Format = g_FormatSl
        '数据绑定
    ...
    Private Sub QueryCgjh()
        If Not String.IsNullOrEmpty(Me.TxtCpdm.Text) Then
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "SELECT CASE WHEN bclosed = 1 THEN '取消关闭' ELSE '关闭' END AS buttontext,bclosed,djh,xh,cpdm,cpmc,dw,sl,cgsl,jhmemo FROM po_cgjh WHERE (cpdm = ? AND sl <> cgsl)"
                rcOleDbCommand.Parameters.Clear()
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles rcDataGridView.CellContentClick
        ...
        If rcDataGridView.Columns(e.ColumnIndex).Name = "ColButtonText" And e.RowIndex > -1 Then
            ...
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "UPDATE po_cgjh SET bclosed = ? WHERE (djh = ? AND xh = ?)"
                rcOleDbCommand.Parameters.Clear()
