...
#Region "窗体初始化"
    ...
    Private Sub FrmPoFpCxz_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '设置DataGridView
        ...
        Me.rcDataGridView.Columns("ColFkje").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.rcDataGridView.Columns("ColFkje").DefaultCellStyle.Format = g_FormatJe
