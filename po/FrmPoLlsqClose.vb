...
Public Class FrmPoLlsqClose
    ...
    Private Sub FrmPoLlsqClose_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '设置DataGridView
        ...
        dtCgjhlb.Columns.Add("cksl", Type.GetType("System.Double"))
        dtCgjhlb.Columns.Add("sqmemo", Type.GetType("System.String"))
    ...
    Private Sub QueryCgjh()
        If Not String.IsNullOrEmpty(Me.TxtCpdm.Text) Then
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "SELECT CASE WHEN bclosed = 1 THEN '取消关闭' ELSE '关闭' END AS buttontext,bclosed,djh,xh,csdm,csmc,cpdm,cpmc,dw,sl,cksl,sqmemo FROM inv_llsq WHERE (cpdm = ? AND sl <> cksl)"
                rcOleDbCommand.Parameters.Clear()
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles rcDataGridView.CellContentClick
        ...
        If rcDataGridView.Columns(e.ColumnIndex).Name = "ColButtonText" And e.RowIndex > -1 Then
            ...
            Try
                ...
                rcOleDbCommand.CommandTimeout = 300
                rcOleDbCommand.CommandType = CommandType.Text
                rcOleDbCommand.CommandText = "UPDATE inv_llsq SET bclosed = ? WHERE (djh = ? AND xh = ?)"
                rcOleDbCommand.Parameters.Clear()
                ...
                rcOleDbCommand.Parameters.Add("@xh", OleDbType.Numeric, 6).Value = rcDataset.Tables("cgjhlb").Rows(e.RowIndex).Item("xh")
