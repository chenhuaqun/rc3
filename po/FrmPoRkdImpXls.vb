    ...
    Private Sub TsbSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TsbSave.Click
        ...
        If Me.RadioButton1.Checked Then
            Try
                ...
                '删除已保存的数据
                rcOleDbCommand.CommandText = "DELETE FROM po_rkd WHERE SUBSTR(djh,1,10) = ?"
        ...
        For i = 0 To rcDataset.Tables("result").Rows.Count - 1
            Try
                ...
                rcOleDbCommand.Parameters.Add("@paraDateRkrq", OleDbType.Date, 8).Value = rcDataset.Tables("result").Rows(i).Item("入库日期")
                ...
                rcOleDbCommand.Parameters.Add("@paraStrYspz", OleDbType.VarChar, 12).Value = rcDataset.Tables("result").Rows(i).Item("原始凭证号")
                ...
                rcOleDbCommand.Parameters.Add("@paraStrSgddh", OleDbType.VarChar, 20).Value = rcDataset.Tables("result").Rows(i).Item("手工订单号")
                rcOleDbCommand.Parameters.Add("@paraStrPiHao", OleDbType.VarChar, 20).Value = rcDataset.Tables("result").Rows(i).Item("批次号")
            ...
            End Try
        Next
        MsgBox("物料入库单读入完成,请检查数据。", MsgBoxStyle.OkOnly + MsgBoxStyle.Question, "提示信息")
        Me.Close()
    End Sub
