...
Public Class FrmCsdmGg
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        ...
        Try
            ...
            '科目余额表
            rcOleDbCommand.CommandText = "SELECT kjnd,kmdm,bmdm,zydm,xmdm,khdm,yhzh,jxzh,'借' AS jd,SUM(CASE WHEN jd ='借' THEN ncsl ELSE 0 - ncsl END) AS ncsl,SUM(CASE WHEN jd ='借' THEN ncwb ELSE 0 - ncwb END) AS ncwb,SUM(CASE WHEN jd ='借' THEN ncje ELSE 0 - ncje END) AS ncje" &
